...
int main (int argc, char *argv[])
{
	...
	double ueTxPower = 23.0; //23.0;        // Transmission power in dBm
	...
	Config::SetDefault ("ns3::LteSpectrumPhy::NistErrorModelEnabled", BooleanValue (false));
    ...
    Config::SetDefault ("ns3::LteEnbNetDevice::UlEarfcn", StringValue ("54990"));  //("23330"));

    // Set pathloss model
    //lteHelper->SetAttribute ("PathlossModel", StringValue ("ns3::Lte3gppPropagationLossModel"));
    lteHelper->SetAttribute ("PathlossModel", StringValue ("ns3::Cost231PropagationLossModel"));
    //lteHelper->SetAttribute ("PathlossModel", StringValue ("ns3::NakagamiPropagationLossModel"));
    //lteHelper->SetAttribute ("PathlossModel", StringValue ("ns3::NistOutdoorPropagationLossModel"));
	...
	preconfiguration.v2xPreconfigFreqList.freq[0].v2xCommPreconfigGeneral.carrierFreq = 54990;//23330;
	...
	UNUSED(sumoCon);
	//sumoCon = new SumoConnection("sumo-gui -c /home/mert/repos/vanet/nlos/nlos.sumo.cfg&",ueAllNodes,ueDevs,numVeh,0.01f,m);
	//sumoCon = new SumoConnection("sumo-gui -c /home/mert/repos/vanet/intersect_tls/intersect.sumo.cfg&",ueAllNodes,ueDevs,numVeh,0.01f,m);
	sumoCon = new SumoConnection("sumo-gui -c /home/mert/repos/vanet/highway_s3_2/highway_s3/hghway.sumo.cfg&",ueAllNodes,ueDevs,numVeh,0.01f,m);
	//sumoCon = new SumoConnection("sumo-gui -c /home/mert/repos/vanet/manhattan/manh.sumo.cfg&",ueAllNodes,ueDevs,numVeh,0.01f,m);
	//sumoCon = new SumoConnection("sumo-gui -c /home/mert/repos/vanet/manhattan/manh2.sumo.cfg&",ueAllNodes,ueDevs,numVeh,0.01f,m);
